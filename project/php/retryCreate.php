<?php
	...
	if(!isset($title)){
	  $title = "<h1>Create User</h1>";
	}if(isset($userEmail, $password, $rePassword, $firstName)){
		include("../../project/menu.php");
		$title = "<h1>Try Again <small>Invalid user name or password </small></h1>";
	}
...
<div class="container">
    ...
    <div class="row-fluid">
        <div class="span8">
            <form action="processUser.php" method="POST" class="form-horizontal" id="createUser">
