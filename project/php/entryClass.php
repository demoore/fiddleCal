...
class entry
{
    ...
    public function editEntry($inUserTableName, $inOldEntryID, $inNewEntry)
    {
        // Make the connection...
        $DBConnection = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);
        ...
        $entryQuery = "UPDATE $inUserTableName
                       SET entryName=\"$inNewEntry\"
                       WHERE entryID=$inOldEntryID";
    ...
    public function getterEntryID()
    {
        return $this->entryID;
    }

    public function setterEntryID($inID){
        $this->entryID = $inID;
    }
